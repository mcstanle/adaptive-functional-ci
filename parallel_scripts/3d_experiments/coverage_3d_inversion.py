...
dimensional numerical example. This script is based on coverage_3d.py.
...
def compute_maxq_i(
        i, data_i, alpha, gamma, eta, M, num_samp, method, hp_dict
):
    """
...
if __name__ == "__main__":
    ...
    NUM_CPU = None
    M = 15000  # number of parameters to sample for each observation
    NUM_SAMP = 15000  # number of draws to estimate each gamma quantile
    METHOD = 'rolling'
    HP_DICT = {'T': 1000}
    ...
    SAVE_FP += f'_rolllingT{HP_DICT["T"]}.npz'
