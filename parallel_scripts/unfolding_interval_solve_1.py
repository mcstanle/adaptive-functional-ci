"""
Script 1 for computing five intervals based on the output from
unfolding_mcmc_chain_gen_1.py (for the parameter samples) and
unfolding_llr_samp_qr_fit_1.py (for the predicted QR maxes, llr samples and
OOS QR predictions).

This scripts is responsible for observations 200-399 and reads in the chains
generated from unfolding_mcmc_chain_gen_1.py.
...
def compute_intervals(
    ...
    print(f'Iteration {i} | llr vals computed')
    ...
    print(f'Iteration {i} | MQ Direct computed')
    ...
    print(f'Iteration {i} | MQmu Param Computed')
    ...
    print(f'Iteration {i} | MQmu Func computed')
