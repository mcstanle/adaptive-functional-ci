"""
Script 4 for computing five intervals based on the output from
unfolding_mcmc_chain_gen_4.py (for the parameter samples) and
unfolding_llr_samp_qr_fit_4.py (for the predicted QR maxes, llr samples and
OOS QR predictions).

This scripts is responsible for observations 800-999 and reads in the chains
