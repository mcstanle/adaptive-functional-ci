"""
Script 2 for computing five intervals based on the output from
unfolding_mcmc_chain_gen_2.py (for the parameter samples) and
unfolding_llr_samp_qr_fit_2.py (for the predicted QR maxes, llr samples and
OOS QR predictions).

This scripts is responsible for observations 400-599 and reads in the chains
generated from unfolding_mcmc_chain_gen_2.py.
